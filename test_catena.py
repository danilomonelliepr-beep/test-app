...
# =============================================================================
import ui as _ui
P("il banner c'è nel pacchetto e viene incorporato nella pagina",
  _ui._banner_incorporato().startswith("data:image/svg+xml;base64,"))
P("il banner è un SVG leggero: pochi KB, perché viaggia dentro la pagina",
  (QUI_TEST / "assets" / "banner-lake.svg").stat().st_size < 20_000)
P("il banner usa i colori esatti del tema, non colori suoi",
  "#15616D" in (QUI_TEST / "assets" / "banner-lake.svg").read_text()
  and "#0E434C" in (QUI_TEST / "assets" / "banner-lake.svg").read_text())
_html_testata = []
...
P("il titolo resta come testo alternativo dell'immagine, per chi non la vede",
  'alt="LAKE: Legacy Application Knowledge Extractor"' in _html_testata[0])
